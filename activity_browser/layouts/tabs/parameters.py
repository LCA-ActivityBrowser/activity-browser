...
#from ...bwutils import presamples as ps_utils #TODO ps
...
class ParameterScenariosTab(BaseRightTab):
    ...
    def calculate_scenarios(self): #TODO ps
    ...
    def build_flow_scenarios(self) -> pd.DataFrame:
        ...
        #ppm = ps_utils.PresamplesParameterManager() #TODO ps
        pm = ParameterManager()
    ...
    # def build_presamples_packages(self, name: str): #TODO ps
