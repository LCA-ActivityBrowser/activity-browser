...
#from activity_browser.bwutils import presamples as ps_utils #TODO ps
from activity_browser.signals import signals
from .models import ScenarioModel
from .views import ABDataFrameView


# class PresamplesList(QComboBox): #TODO ps
...
#
#     @property
#     def has_packages(self) -> bool: #TODO ps
#         return bool(ps_utils.count_presample_packages())
#
#     @staticmethod
#     def get_package_names() -> List[str]: #TODO ps
