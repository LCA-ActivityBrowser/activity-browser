    ...
    def run():
        ...
        if project_to_delete == ab_settings.startup_project:
            QtWidgets.QMessageBox.information(
                ...
                _("Not possible"),
                _(
                    "The startup project cannot be deleted. Select a different "
                    "startup project in Settings first."
                ),
            )
            return
        ...
        delete_dialog = ProjectDeletionDialog.construct_project_deletion_dialog(
            application.main_window, bd.projects.current
        )
        ...
        bd.projects.delete_project(
            project_to_delete, delete_dialog.deletion_warning_checked()
        )
        ...
        QtWidgets.QMessageBox.information(
            application.main_window,
            _("Project deleted"),
            _("The project was successfully deleted."),
        )
